Shader "Hidden/Locked/.poiyomi/• Poiyomi Toon •/RED Pants-RED Pants"
{
    Properties
    {
...
#define PROP_DECALEMISSIONSTRENGTH 0.02
...
#define PROP_MATCAP2EMISSIONSTRENGTH 0.06
#define PROP_MATCAP2INTENSITY 1.7
