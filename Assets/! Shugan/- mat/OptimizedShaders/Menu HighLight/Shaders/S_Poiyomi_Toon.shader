Shader "Hidden/Locked/.poiyomi/• Poiyomi Toon •/Menu HighLight-Menu HighLight"
{
    Properties
    {
...
#define PROP_SATURATION 0.3
#define PROP_MAINBRIGHTNESS 0.452
...
#define PROP_DECALEMISSIONSTRENGTH 5.83
