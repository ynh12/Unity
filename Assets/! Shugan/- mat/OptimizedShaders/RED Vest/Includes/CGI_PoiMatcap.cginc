    ...
    void applyMatcap(inout float4 finalColor, inout float3 matcapEmission)
    {
        ...
        blendMatcap(finalColor, float(0.07), float(0.114), float(0), matcap, matcapMask, matcapEmission, float(0)
        #ifdef POI_LIGHTING
        , float(0)
        #endif
        #ifdef POI_BLACKLIGHT
        , _BlackLightMaskMatcap
            ...
            blendMatcap(finalColor, float(0.676), float(0.436), float(0), matcap2, matcap2Mask, matcapEmission, float(0.003)
            #ifdef POI_LIGHTING
            , float(0)
            #endif
            #ifdef POI_BLACKLIGHT
