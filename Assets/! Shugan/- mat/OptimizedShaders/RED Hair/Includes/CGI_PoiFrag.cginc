...
float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
{
	...
	**********************************************************************/
		...
		#ifdef POI_SPECULAR
			meta.SpecularColor = poiLight.color.rgb * float4(0.03864443,0.03864443,0.03864443,1).rgb * lerp(1, albedo.rgb, float(1)) * float4(0.03864443,0.03864443,0.03864443,1).a;
		#else
