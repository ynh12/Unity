Shader "Hidden/Locked/.poiyomi/• Poiyomi Toon •/RED Stockings-RED Stockings"
{
    Properties
    {
...
#define PROP_DECALBLENDTYPE 1
#define PROP_DECALBLENDALPHA 0.9
...
#define PROP_DECALBLENDTYPE1 1
#define PROP_DECALBLENDALPHA1 0.9
